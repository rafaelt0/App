...
data_inicio = st.sidebar.date_input("Data Inicial📅", datetime.date(2020,1,1),min_value=datetime.date(2000,1,1))
...
try:
    ...
    ef.add_objective(objective_functions.L2_reg, gamma=1_000_000)
